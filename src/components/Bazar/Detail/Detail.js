      ...
      <Modal visible={isModalVisible} animationType="slide" transparent={true}>
        <ScrollView style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            {allProducts?.related_categories &&
              allProducts.related_categories.length > 0 && (
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[
                        ...
                        {
                          color:
                            location === items.name ? 'red' : colors.primary,
                        },
                      ]}>
                      {items.name}
                    </Text>
            ...
            {allProducts?.businesstype &&
              allProducts.businesstype.length > 0 && (
                <View style={styles.relatedCategory}>
                  <View style={styles.filterSectionHeader}>
                    <Icon name="format-align-justify" size={20} color="black" />
