...
const About = ({navigation}) => {
  ...
  const renderCoreServices = () => {
    const services = [
      {
        ...
        description:
          'Professional tax filing and optimization services for individuals and businesses',
        color: '#2E8B57',
      },
      {
        icon: 'trending-up',
        ...
        description:
          'Strategic business advice to help grow and optimize your operations',
        color: '#4682B4',
      },
      {
        icon: 'document-text',
      ...
      },
      {
        ...
        description:
          'Business formation, compliance, and corporate governance solutions',
        color: '#8B4513',
      },
    ];
    ...
    const serviceCardWidth =
      (dimensions.width - getResponsiveValue(48, 64, 80)) / serviceColumns -
      (serviceColumns > 2 ? 8 : 0);
  ...
  const decodeHtmlEntities = text =>
    typeof text === 'string' ? he.decode(text) : '';
              ...
              <View
                ...
                {team.myteam.map((member, memberIndex) => {
                  ...
                  const memberCardWidth =
                    (dimensions.width - getResponsiveValue(48, 64, 80)) /
                      teamColumns -
                    (teamColumns > 2 ? 8 : 0);
